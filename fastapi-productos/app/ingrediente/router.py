...
def read_ingrediente(ingrediente_id: int, db: SessionDep):
...
def update_ingrediente(ingrediente_id: int, ingrediente: schema.IngredienteCreate, db: SessionDep):
...
def delete_ingrediente(ingrediente_id: int, db: SessionDep):
